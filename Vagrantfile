...
Vagrant.configure(2) do |config|
    ...
    config.vm.define "rtr1" do |node|
      ...
      # Forward a port for netconf server access from the host, for eg. port 830 configured on XR, forwarded to 57780 on host
      node.vm.network :forwarded_port, guest: 830, host: 57780, id: "netconf", auto_correct: true
